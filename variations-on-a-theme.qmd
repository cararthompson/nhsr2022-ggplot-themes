...
A quick aside: `theme_minimal()+` or `theme_minimal() %+replace% `?
...
::: fragment
Using `theme_minimal() + ...` to keep some of it as a helpful starting point
:::
...
![](images/mics_demo.png)


## Three reasons for using a bespoke theme {auto-animate=true background=#2C3D4F}
